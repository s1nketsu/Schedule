...
class TaskColorsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: idTaskScheduleCellHeader) as! HeaderOptionsTableViewCell
    ...
    private func setColor(color: String) {
        let tasksOptions = self.navigationController?.viewControllers[1] as? TasksOptionTableView
